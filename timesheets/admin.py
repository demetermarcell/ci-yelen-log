...
class TimesheetAdmin(admin.ModelAdmin):
    list_display = ('user', 'project', 'start_date', 'end_date', 'status', 'total_hours_logged', 'slug')
...
class DayAdmin(admin.ModelAdmin):
    list_display = ('timesheet', 'day_date', 'day_name', 'status', 'total_hours_logged')
...
class TaskAdmin(admin.ModelAdmin):
    ...
    search_fields = ['day__timesheet__user__username', 'day__timesheet__project__name']
